      ...
      <nav className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#" className="flex items-center gap-3 group">
            <span className="text-xl font-bold tracking-tight">InterviewPilot</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors font-mono"
            >
        ...
        >
          <div className="flex flex-col gap-3 pt-4 border-t border-border/50">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-4 py-2 text-sm text-muted-foreground hover:text-foreground font-mono flex items-center justify-between"
            >
